...
function comecar(){
    ...
    document.getElementById("recarregar").onclick = outraCartela; //Vai gerar uma nova cartela qunado clicar no "Clique Aqui"
}
...
let coluna = new Array (
    ...
    //pNumero recebe a posição do numero e identica ele no HTML.
    

    let baseColuna = coluna[thisNumero]*15;
    //cada coluna gera um numeros em um intervalor de 15 números.
    ...
    document.getElementById(pNumero).onmousedown = trocarCor
}
